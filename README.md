...
A market-anchored NBA sides system, and the full research record behind it: **a register that runs to D227, most entries rejections.**

Results summary: **[docs/REVIEW.md](docs/REVIEW.md)**, rendered to [PDF](nba_model_and_strategy_review.pdf) from that same file so the two cannot drift.
...
Suggested reading order: [docs/REVIEW.md](docs/REVIEW.md) (results), [docs/DECISIONS.md](docs/DECISIONS.md) (the register), [docs/GATE_POLICY_V2.md](docs/GATE_POLICY_V2.md) (how a change earns its way in), [docs/LEAKAGE.md](docs/LEAKAGE.md), [docs/CONSTANTS.md](docs/CONSTANTS.md), [docs/OCTOBER_RUNBOOK.md](docs/OCTOBER_RUNBOOK.md).
