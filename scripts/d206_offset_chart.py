...
def main():
    ...
    # D207: the document frame is 2019-20 onward; the chart must match it or the
    # figure contradicts the text above it (it did, in the first PDF build).
    FROM = "2019-20"
    ...
    fig.suptitle("Simulation performance — NBA opening-spread relative value (MARKET-OFFSET)",
    ...
    out = ROOT / "charts" / "sim_report_equity_offset.png"
